 ...
 *
 * I spent 4 or 5 hours one evening writing this.
 *
 * The AI not only examines the current board, but also models any possible move that the opponent could
 * make (after any of our possible moves).
 *
