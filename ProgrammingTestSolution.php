...
/*
Solution to a programming test exercise:

"Create a new Request Header based on the clients IP address in order to determine the users network. (Keeping in mind that you user might be behind a proxy server.)
